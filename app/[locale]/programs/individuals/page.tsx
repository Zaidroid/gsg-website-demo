...
export default function IndividualsPage() {
    ...
    return (
        <main className="bg-transparent min-h-screen">
            <PageHeader
                title={t("individuals.header.title")}
                description={t("individuals.header.description")}
            />
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                        ...
                        <div className="flex flex-col rounded-3xl bg-white/40 dark:bg-slate-900/40 backdrop-blur-xl border border-white/50 dark:border-white/10 p-8 shadow-xl hover:scale-[1.02] transition-transform duration-300">
                            ...
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t("code_academy.header.title")}</h3>
                            <p className="text-gray-700 dark:text-slate-300 mb-8 flex-grow">
                                {t("code_academy.header.description")}
                            </p>
                            <Link href="/programs/code-academy">
                                <Button className="w-full gap-2 dark:bg-white dark:text-slate-900 font-bold">
                                    {t("individuals.view_program")} <ArrowRight size={16} />
                                </Button>
                            </Link>
                        </div>
                        ...
                        <div className="flex flex-col rounded-3xl bg-white/40 dark:bg-slate-900/40 backdrop-blur-xl border border-white/50 dark:border-white/10 p-8 shadow-xl hover:scale-[1.02] transition-transform duration-300">
                            ...
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t("freelance_academy.header.title")}</h3>
                            <p className="text-gray-700 dark:text-slate-300 mb-8 flex-grow">
                                {t("freelance_academy.header.description")}
                            </p>
                        ...
                        <div className="flex flex-col rounded-3xl bg-white/40 dark:bg-slate-900/40 backdrop-blur-xl border border-white/50 dark:border-white/10 p-8 shadow-xl hover:scale-[1.02] transition-transform duration-300">
                            ...
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t("geexelerator.header.title")}</h3>
                            <p className="text-gray-700 dark:text-slate-300 mb-8 flex-grow">
                                {t("geexelerator.header.description")}
                            </p>
